...
OUT_DIR = ROOT / "output/analysis_candidates/phase3_rd/bluetooth_t1_week_any_data_pilot"
LONG_PATH = OUT_DIR / "phase3_rd_bluetooth_t1_week_any_data_long.csv"
WIDE_PATH = OUT_DIR / "phase3_rd_bluetooth_t1_week_any_data_wide.csv"
STATUS_PATH = OUT_DIR / "phase3_rd_bluetooth_t1_week_any_data_status.csv"
README_PATH = OUT_DIR / "README_phase3_rd_bluetooth_t1_week_any_data.md"


def t1_week_window(patient: pd.Series) -> dict:
    t1_date = pd.Timestamp(str(patient["T1_date_iso"])).tz_localize(TZ)
    week_start = t1_date
    week_end = week_start + pd.Timedelta(days=7)
    return {
        "window_rule": "rd_t1_week_any_bluetooth_data",
...
def build_readme() -> str:
    return """# Phase 3 R&D: Bluetooth T1-Week Any-Data Pilot
...
def main() -> None:
            ...
            if not device_ids:
                ...
                try:
                    ...
                    if rows:
                        ...
                        table_status = "missing_no_bluetooth_rows_in_t1_week"
                ...
                long_rows.append(
                    {
                        ...
                        "rows_in_window": len(rows),
                        "device_ids_used": ";".join(sorted(device_ids_used)),
                        "calculation_context": "phase3_rd_bluetooth_t1_week_any_data",
                        "error_message": error_message,
                    }
                )
    finally:
    ...
    print(f"patients_with_bluetooth_in_t1_week: {calculated_patients}")
