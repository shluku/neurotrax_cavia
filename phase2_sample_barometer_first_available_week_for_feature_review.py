...
TABLE_NAME = "barometer"
OUT_DIR = ROOT / "output/analysis_candidates/phase2_feature_review/barometer"
PREFIX = "barometer_adjusted_first_available_7d"
SAMPLE_LIMIT = 20
MIN_ROWS = 20
WINDOW_DAYS = 7
...
def write_outputs(window: dict[str, Any] | None, coverage_rows: list[dict[str, Any]], rows: list[dict[str, Any]]) -> list[Path]:
    ...
    readme_path = OUT_DIR / "README_barometer_adjusted_first_available_7d_review.md"
...
"""
        ...
        window_text = "\nNo mapped ranked patient had at least 20 rows in the first 7 days after first available barometer data.\n"

    readme_path.write_text(
        f"""# barometer Adjusted First-Available 7-Day Review
