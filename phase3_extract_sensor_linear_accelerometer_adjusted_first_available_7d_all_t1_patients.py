...
def build_readme(patient_count: int) -> str:
    return f"""# Phase 3 sensor_linear_accelerometer Adjusted First-Available 7-Day Extraction
...
2. Require at least {MIN_ROWS} row in the first 7 days from that timestamp.
                ...
                for attempt in range(3):
                    try:
                        ...
                        if "start_ms" not in window:
                            table_status = "missing_no_adjusted_first_available_sensor_linear_accelerometer_1row_window_after_T1"
                        else:
                ...
                long_rows.append(
                    {
                        ...
                        "rows_in_window": len(rows),
                        "device_ids_used": ";".join(device_ids_used),
                        "calculation_context": "all_t1_patients_sensor_linear_accelerometer_adjusted_first_available_7d_after_T1",
                        "error_message": error_message,
                    }
                )
    finally:
