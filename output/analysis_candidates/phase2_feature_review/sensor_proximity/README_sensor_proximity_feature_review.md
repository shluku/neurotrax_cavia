# sensor_proximity Phase 2A Feature Review Sample

This folder contains a Phase 2A manual-review sample for `sensor_proximity`.
...
- `sensor_proximity_sample_rows.csv`
- `sensor_proximity_sample_rows_expanded.csv`
- `sensor_proximity_sample_rows.jsonl`
- `sensor_proximity_json_key_summary.csv`
- `sensor_proximity_phase2a_t1_ranked_coverage_scan.csv`
