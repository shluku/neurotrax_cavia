# keyboard Phase 2A Feature Review Sample

This folder contains a Phase 2A manual-review sample for `keyboard`.
...
- n_rows_in_window: `1832`

Files:

- `keyboard_sample_rows.csv`
- `keyboard_sample_rows_expanded.csv`
- `keyboard_sample_rows.jsonl`
- `keyboard_json_key_summary.csv`
- `keyboard_phase2a_t1_ranked_coverage_scan.csv`
