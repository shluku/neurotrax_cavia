# wifi Phase 2A Feature Review Sample

This folder contains a Phase 2A manual-review sample for `wifi`.
...
- `wifi_sample_rows.csv`
- `wifi_sample_rows_expanded.csv`
- `wifi_sample_rows.jsonl`
- `wifi_json_key_summary.csv`
- `wifi_phase2a_t1_ranked_coverage_scan.csv`
