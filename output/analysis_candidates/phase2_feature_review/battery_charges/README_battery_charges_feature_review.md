# battery_charges Phase 2A Feature Review Sample

This folder contains a Phase 2A manual-review sample for `battery_charges`.
...
- `battery_charges_sample_rows.csv`
- `battery_charges_sample_rows_expanded.csv`
- `battery_charges_sample_rows.jsonl`
- `battery_charges_json_key_summary.csv`
- `battery_charges_phase2a_t1_ranked_coverage_scan.csv`
