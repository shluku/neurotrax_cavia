# screen Phase 2A Feature Review Sample

This folder contains a Phase 2A manual-review sample for `screen`.
...
- n_rows_in_window: `304`

Files:

- `screen_sample_rows.csv`
- `screen_sample_rows_expanded.csv`
- `screen_sample_rows.jsonl`
- `screen_json_key_summary.csv`
- `screen_phase2a_t1_ranked_coverage_scan.csv`
