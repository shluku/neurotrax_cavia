# light Phase 2A Feature Review Sample

This folder contains a Phase 2A manual-review sample for `light`.
...
- n_rows_in_window: `228215`

Files:

- `light_sample_rows.csv`
- `light_sample_rows_expanded.csv`
- `light_sample_rows.jsonl`
- `light_json_key_summary.csv`
- `light_phase2a_t1_ranked_coverage_scan.csv`
