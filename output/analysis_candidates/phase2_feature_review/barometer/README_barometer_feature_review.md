# barometer Phase 2A Feature Review Sample

This folder contains a Phase 2A manual-review sample for `barometer`.
...
- `barometer_sample_rows.csv`
- `barometer_sample_rows_expanded.csv`
- `barometer_sample_rows.jsonl`
- `barometer_json_key_summary.csv`
- `barometer_phase2a_t1_ranked_coverage_scan.csv`
