# plugin_google_activity_recognition Phase 2A Feature Review Sample

This folder contains a Phase 2A manual-review sample for `plugin_google_activity_recognition`.
...
- n_rows_in_window: `423`

Files:

- `plugin_google_activity_recognition_sample_rows.csv`
- `plugin_google_activity_recognition_sample_rows_expanded.csv`
- `plugin_google_activity_recognition_sample_rows.jsonl`
- `plugin_google_activity_recognition_json_key_summary.csv`
- `plugin_google_activity_recognition_phase2a_t1_ranked_coverage_scan.csv`
