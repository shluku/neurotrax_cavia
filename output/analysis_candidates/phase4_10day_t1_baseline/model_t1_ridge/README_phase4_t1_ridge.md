...
- `primary_37`: mean RMSE `8.532`, ridge RMSE `8.661`, ridge minus mean `0.129`, ridge R2 `-0.031`.
- `t1_week_all_available`: mean RMSE `8.532`, ridge RMSE `8.712`, ridge minus mean `0.180`, ridge R2 `-0.043`.
- `primary_plus_adjusted`: mean RMSE `8.532`, ridge RMSE `8.661`, ridge minus mean `0.129`, ridge R2 `-0.031`.
- `all_available`: mean RMSE `8.532`, ridge RMSE `8.712`, ridge minus mean `0.180`, ridge R2 `-0.043`.
