...
Calibration checks whether predicted scores track actual scores on the correct scale. For the primary ridge model: RMSE `8.717`, MAE `6.976`, calibration slope `-1.339`, intercept `229.081`, and actual-predicted correlation `-0.147`.
