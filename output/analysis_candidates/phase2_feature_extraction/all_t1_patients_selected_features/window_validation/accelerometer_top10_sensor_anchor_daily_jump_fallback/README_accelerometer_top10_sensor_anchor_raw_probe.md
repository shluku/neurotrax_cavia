...
- Patient-level table: `output/analysis_candidates/phase2_feature_extraction/all_t1_patients_selected_features/window_validation/accelerometer_top10_sensor_anchor_daily_jump_fallback/accelerometer_top10_sensor_anchor_raw_probe_patient_windows.csv`
...
- Patient rows: 1
- Metadata candidates probed: 1
- Hourly probe rows: 0

Patient window status counts:

- `raw_window_found_from_sensor_anchor_probe`: 1
